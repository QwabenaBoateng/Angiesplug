    ...
    <div className={`relative overflow-hidden rounded-2xl group cursor-pointer ${isLarge ? 'row-span-2' : ''}`}>
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex items-end">
        <div className="p-6 w-full">
          ...
          <h3 className="text-2xl font-black text-slate-900 mb-2 group-hover:text-blue-400 transition-colors leading-none">{category.name.toUpperCase()}</h3>
          {isLarge && (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-left animate-in fade-in slide-in-from-left-8 duration-1000">
              ...
              <h1 className="text-6xl md:text-8xl font-black mb-6 leading-none tracking-tighter text-slate-900">
            ...
            <div className="hidden lg:block relative animate-in fade-in zoom-in duration-1000">
              <div className="relative z-10 animate-float">
                <img 
                  ...
                  alt="Hero Look" 
                  className="rounded-[2.5rem] shadow-2xl shadow-blue-500/10 border border-slate-200"
                />
                {/* Floating Cards */}
                <div className="absolute -right-12 top-1/4 glass p-4 rounded-2xl shadow-2xl border border-slate-200 animate-float" style={{ animationDelay: '-2s' }}>
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center font-bold text-white small">E</div>
                    <div>
                      <p className="text-xs font-bold text-slate-900">New Drop</p>
                      <p className="text-[10px] text-slate-600">2 mins ago</p>
                    </div>
                  </div>
                </div>
                <div className="absolute -left-12 bottom-1/4 glass p-5 rounded-2xl shadow-2xl border border-slate-200 animate-float" style={{ animationDelay: '-1s' }}>
                  <div className="flex items-center space-x-1 mb-1">
                    {[...Array(5)].map((_, i) => <Star key={i} size={10} className="fill-amber-400 text-amber-400" />)}
                  </div>
                  <p className="text-[10px] font-bold text-slate-900">"Best quality ever!"</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter">FEATURED <span className="text-gradient">LOOKS</span></h2>
            </div>
            <Link to="/shop" className="text-sm font-bold text-blue-400 hover:text-slate-900 transition-colors flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                ...
                <div className="p-10 flex flex-col justify-center">
                  ...
                  <div className="mb-8 flex items-baseline space-x-2">
                    <span className="text-5xl font-black text-slate-900">{promoContent.promo_discount_percentage}</span>
            ...
            <div className="relative rounded-[2rem] overflow-hidden group">
              ...
              <div className="absolute bottom-10 left-10 right-10 flex flex-col sm:flex-row justify-between items-end gap-6">
                <div>
                  ...
                  <h3 className="text-4xl font-black text-slate-900 tracking-tighter uppercase">Exquisite <br /> Lifestyle</h3>
                </div>
      ...
      <section className="py-24 bg-[#f8f8f6]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter">OUR <span className="text-gradient">BRANDS</span></h2>
          </div>
