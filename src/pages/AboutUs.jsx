...
Exquisite Boutique is my way of hooking you all up with the gear you really want. This isn't just my business; it's my passion. Every piece is chosen with love."`
  ...
  return (
    <div className="min-h-screen bg-[#f8f8f6] text-slate-900 overflow-hidden">
      {/* Hero Header */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20">
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-10 rounded-[2.5rem] text-center border-slate-200 hover:border-indigo-500/20 transition-all">
            ...
            <div className="glass-card p-10 rounded-[2.5rem] text-center border-slate-200 hover:border-blue-400/20 transition-all">
